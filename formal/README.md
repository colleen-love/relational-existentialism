...
| **Feeling = relational decoherence differential** — what you've collapsed that an other still holds superposed (`≅ₒ`, not the view-from-nowhere `≅`); conserved coherence carried, discharged by communication; betrayal the same shape reversed | `RelExist.Feeling.{feel, feel_eq, feel_unshared, feel_shared, feel_le_between, betrayal_feel}` | [03.3](../docs/spec/03.3-decoherence.md) | Scratch | ✅ proved |

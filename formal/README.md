...
| **The seam bridge, closed** — the abstract Lawvere agent *is* the actual forgetting: `restrict`/`traceAgent` instantiated at the concrete marginal (no longer posited) | `RelExist.SeamBridge.{forget, forget_lossy, no_faithful_self_trace, seam_on_forgetting}` | [03.3](../docs/spec/03.3-decoherence.md) | core (no mathlib) | ✅ **0 axioms** |

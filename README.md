...
**[Spec 2.0. — Ontology, Arena, and Axioms](./scratch/spec/2-0.md)**

**[Spec 2.1. — Signature, Dyad Reduction, and Construction of Ω](./scratch/spec/2-1.md)**

**[Spec 2.2. — π Ratified, Witnessing, and Comparative Composition Theory](./scratch/spec/2-2.md)**
...
Series 2 is active. Spec 2.00 is normative; successor specs (2.01: the enriched setting and finality; 2.02: operations and measures of closure; 2.03: self-reference) are in progress. The immediate mechanization targets are T1 and propositions P0–P3, which are independent of all open machinery. Open problems are cataloged in spec §8 — the hard core is finality in the self-generated quantaloid-enriched setting (O1) and the scarcity theorem (O2).

/-
`series-8/formal/Series8/ws6.lean`

WS6 — **The heuristic ceiling.** Series 8, the honest boundary.
...
Design doc: `series-8/spec/ws6-design.md`.
...
open Series8.WS1 Series8.WS3 Series8.WS4 Series8.WS5 Cardinal

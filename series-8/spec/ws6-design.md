...
**Design doc. Series 8, the honest boundary. Owns: the universal forms of Consequence 3 (layering-as-narrowing, WS4) and the conservation law (WS5) where they exceed what is rangeable, reported as defended theses floored by the mechanized core — the Series 4/5/7 pattern.**

*Series 8 is standalone; names transcribed into `series-8/formal/Series8/ws6.lean`, re-namespaced `Series8.WS6` (see `spec/README.md` §6). WS6 **consumes WS4 and WS5** (protocol §4): it re-exports their mechanized cores as the *floor* of two theses whose universal quantifiers are not rangeable, and it names precisely what is proved versus what is defended. It introduces no new object; it draws the line.*

## The object at stake

Charter §5.3, §6 (WS6), §9. Two of Series 8's claims have a universal form that quantifies over *every construction* — un-formalizable in the same way Series 7's trichotomy-exhaustiveness and Series 4/5's universals were:
...
- **Partial (the honest ceiling, pre-registered):** the universal forms of layering-as-narrowing and mere-boundedness (D4) — defended theses floored by the mechanized core, the all-constructions quantifier the obstruction (charter §5.3, the Series 4/5/7 pattern).

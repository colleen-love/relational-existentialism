...
### C1 — Series 07's mathematical delta over Series 06 is vocabulary plus a one-line generalization. · framing
...
**Correction (framing only):** downgrade "Series 07 proves a new Import Theorem" to "reframes S6's Static Collapse in import vocabulary and adds the general bisimilarity lemma." No code change.

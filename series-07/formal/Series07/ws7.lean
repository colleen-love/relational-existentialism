/-
`series-07/formal/Series07/ws7.lean`

WS7 — **The anti-circularity audit, and the typed verdict.** Series 07, runs last.
...
program's founding predicate (used in Series 04–06, not gerrymandered) — is a USAGE claim stated in
...
open Series07.WS1 Series07.WS3 Series07.WS4 Cardinal

variable {κ : Cardinal.{u}}

/-- Series 07's three outcomes (transcribed base, re-pointed). -/
...
does NOT certify that the Series 04 restriction is an import — it is not (recoverable ⇒ not an

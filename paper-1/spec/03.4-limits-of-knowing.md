...
can never take on itself — is [03.5](03.5-decoherence.md).
...
**The bridge to the trace setting.** `[proved]` The inversion `≈ ⊊ ≅` ([03.5](03.5-decoherence.md))
...
[03.5](03.5-decoherence.md) · the quantitative limit of self-in-other is

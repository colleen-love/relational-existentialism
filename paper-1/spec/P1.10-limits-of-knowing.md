# P1.10 — The limits of knowing

> Part of [paper one](paper-one.md). What the theory says about relating, by **which wires
...
can never take on itself — is [03.5](P1.08-decoherence.md).
...
**The bridge to the trace setting.** `[proved]` The inversion `≈ ⊊ ≅` ([03.5](P1.08-decoherence.md))
...
→ Back to [paper one](paper-one.md) · the decoherence reading of knowing is
[03.5](P1.08-decoherence.md) · the quantitative limit of self-in-other is

...
can never take on itself — is [03.5](P1.8-decoherence.md).
...
**The bridge to the trace setting.** `[proved]` The inversion `≈ ⊊ ≅` ([03.5](P1.8-decoherence.md))
...
[03.5](P1.8-decoherence.md) · the quantitative limit of self-in-other is

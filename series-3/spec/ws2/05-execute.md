...
Now add ws2 to the build and the Series3 root, then compile:
...
**`series-3/formal/ws2.lean`** — realizes `04-charter-design-review.md` (Framings 1+3+4+2+5), built on the imported WS1 theorems, wired into the build via `import ws2` in `Series3.lean` and the library roots.

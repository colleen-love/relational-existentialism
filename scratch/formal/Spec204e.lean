/-
Spec 2.04e — the Lambek-free infinitude of Ω_R, and T16 at the ω-tier (2-04-mechanization-c).

Normative source: `scratch/spec/2-04.md` and the work order `2-04-mechanization-c.md`. Continues
...
/-! ## Stage 0, Route C — `Infinite Ω_R`, Lambek-free (2-04-mechanization-c §0; FP-C1) -/
...
/-! ## Stage 1 — T16_ω (2-04-mechanization-c §1 = order b Stage 2; FP-B3) -/
...
HONESTY CAVEAT (mandatory, 2-04-mechanization-c §1): this is **scaffold-assisted** T16 — the

/-
Spec 2.04f — Lambek by hand for the corrected functor (2-04-mechanization-c Stage 0, Route A).

Normative source: `scratch/spec/2-04.md` §2 and `2-04-mechanization-c.md` Stage 0 Route A. Continues
...
the "Lambek in both sorts" claim of 2-04 §2's construction paragraph. FP-C2: the univariate bisim
...
structure isomorphism (2-04 §2). Retires the "Lambek in both sorts" claim of the construction

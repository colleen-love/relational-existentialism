/-
Spec 2.04c — The construction: νHC, the corrected universe Ω_C, and its finality (Stages 2–3).

Normative source: `scratch/spec/2-04.md` §4 (construction), §2 (Ω_C := greatest coherent
subcoalgebra), and the work order `2-04-mechanization-a.md` Stages 2–3. Continues `Spec204b.lean`
...
`2-05`/`Spec205` off-by-one, resolved spec-first).
-/
import Spec204b
...
/-! ## The QPF for HC (the technical heart, 2-04 §4)
...
/-! ## Ω_C — the corrected universe (2-04 §4, Stage 3)

/-
Spec 2.05b — T7 (identity as the limit of observer-local equalities), the T4 close-out, the
depth-family bridge, and the Stage 4–5 attempts of the closing contract.

Normative source: `scratch/spec/2-05.md` (§5 the formal targets, T7 / FP-D5; §6 FP-D7) and the work
order `2-05-mechanization-a.md` Stages 3–5. Continues `Spec205.lean` (the D19 pack). Specs win.

STANDING DISCIPLINE (2-05-mechanization-a): no proof term below depends on D19 for its mathematics.
...
oldest strong claim (2-00 §2.6 as corrected, A3's strong form) lands in full over Ω_C, and it lands
on BOTH sorts:
...
/-! ## Stage 3 — T7, relation sort: the coinductive core (2-05 §5, FP-D5)
...
/-- **T7, coinductive core** — 2-05 §5, FP-D5: two relations of Ω_R related by any bisimulation are
...
The substantive direction the framework has carried since 2-00 §2.6: `∀ w, ApproxW w x y → x = y`.
...
/-- **T7 — THE HEADLINE**, 2-05 §5, FP-D5: over Ω_C, `identity is the limit of observer-local
...
object of Ω_C IS its pattern). A3's strong form, 2-00 §2.6 as corrected — landed in full over the
...
/-! ## Stage 3 — T4 close-out (2-05 §5): the profile/π reconciliation, O8 ratified
...
recorded here per the order, pointer to 2-05 §5). -/
...
/-! ## Stage 3 — the depth-family bridge (2-05 §5): EqDepth reflexivity, forward direction -/
...
face of "identity is the limit of depth-wise agreement" (2-00 §2.6). The reverse ω-limit
...
/-! ## Stage 4 — reach_infinite (2-05 §5, T10 partial; SHOULD)
...
/-! ## Stage 5 — C2-strong, hostile (2-05 §6, FP-D7; SHOULD)
...
constructed universe share no relation — `π = ∅`. Recorded against 2-02 §1.2: the strong overlap
...
/-
================================================================================
2-05-mechanization-a Stages 3–5 ↔ this file
================================================================================

/-
Spec 2.03c — Close the Trials: the Relocation Conjecture, the one-bit audit, and the Ascent.

Normative source: `scratch/spec/2-03-mechanization-c.md` — the order — which carries its
...
Scope note (2-03-mechanization-c §1): (C)'s coherence/parthood design is OUT of scope and
gates B4/B5 — everything here is pre-design. The O-2-03-2 "pairs" check is discharged in
...
/-! ## BIT — the one-bit audit of A2 (2-03-mechanization-c §3; P1)
...
/-- The canonical remainder witness (2-03 §5.1). -/
...
/-! ## RELOC — the Relocation Conjecture (2-03-mechanization-c §4; C-B6, P2/P3)
...
reductions dissolve the fork into a lattice (2-03 §5.2 B6). -/
...
/-- The (C)-shape realizing an (A)-datum `a` (2-03-mechanization-c §4 construction plan). One
...
/-! ## ASCENT — stage-wise non-collapse and growth (2-03-mechanization-c §5; P4/P6)
...
/-
================================================================================
2-03-mechanization-c §2 predictions ↔ outcomes  (see 2-03 §5.7 for the prose transcript)
================================================================================
...
--
-- Deviations from 2-03-mechanization-c.md:

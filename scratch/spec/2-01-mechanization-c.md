# 2.01-mechanization-c — Work Order: νF at the ω-Tier, and the Discharge of T2

**This document describes:** `scratch/formal/Spec201c.lean` (new file; imports `Spec201`, `Spec201b`)
**Normative sources:** `scratch/spec/2-01.md` §4 (the literature-verified construction) and `scratch/spec/2-00.md` (current revision; D9-R3, D18). Where this document and the specs disagree, the specs win; report, don't improvise.
**Audience:** Claude Code. This is the most technical order of Series 2 — the construction order. All prior conventions in force. Naming follows the repo's own convention (`2-01-mechanization-b.md` precedent): this is the third mechanization of spec 2-01's ground.
...
```lean
/-- HONESTY ITEM (2-01 D4 made formal). `IsFinalRaw` — finality over ALL Raws,
...
`omegaHat_coherent` shows is inhabited. Ω exists. The κ-loan (2-01 D4) is

/-
`series-07/formal/Series07/ws6.lean`

WS6 — **The heuristic ceiling.** Series 07, the honest boundary.
...
admits no honest formalizable quantifier, exactly as Series 04/05 reported their forced answers.

Design doc: `series-07/spec/ws6-design.md`, C1 (core mechanized) + C4 (universal heuristic).
...
open Series07.WS1 Series07.WS3 Cardinal

variable {κ : Cardinal.{u}}

/-- **D1 — the provable core.** The static collapse (lemma-driven, WS2), the transcribed dynamic
collapse (Series 06), and the single-coalgebra dichotomy (WS3, `ws3_dichotomy`), conjoined — an
explicit disjunction over the shapes Series 07 mechanizes, with a genuine ∀ inside each conjunct
...
theorem ws6_provable_core (hinf : ℵ₀ ≤ κ) :
  ...
  ⟨fun dest hb ha => Series07.WS2.ws2_import_theorem_static dest hb ha,
...
register of Series 04/05's forced answers. -/

/-
`series-07/formal/Series07/ws3.lean`

WS3 — **The trichotomy of distinction.** Series 07, the theorem's teeth.
...
Design doc: `series-07/spec/ws3-design.md`, candidate C1 (kinds independently characterized,
...
distinguishing quality (import-like: it tells states apart). The Series 04 restriction `x↾(x,y)` is
...
either way. It needs a carrier that supports the restriction (the `νLk` face), which Series 07 does
not transcribe. Recorded as a named open, routed to a possible Series 08. -/

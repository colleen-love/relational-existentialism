/-
`series-06/formal/ws3.lean`

WS3 — **The engine: incompleteness as fuel.** Series 06, the signature crux.
...
Design doc: `series-06/spec/ws3-design.md`, candidate C1 (`Δ`/`stepM` literally

/-
`series-06/formal/ws2.lean`

WS2 — **The Static Collapse, and the forced answer.** Series 06, the intellectual spine.
...
Design doc: `series-06/spec/ws2-design.md`, candidate C2 (abstract `Static` +
...
namespace Series06.WS2

open Series06.WS1 Cardinal

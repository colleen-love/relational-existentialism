...
ws8 compiled first try. Now import in Series03.lean, full build, and axiom check.
...
Done. Merged `main`, wrote `series-03/formal/ws8.lean`, imported it in `Series03.lean`, added `"ws8"` to the lakefile roots. **Full build compiles, sorry-free.**

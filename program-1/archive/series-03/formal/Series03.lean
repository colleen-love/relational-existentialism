-- `Series03` — the live Lean root (Spec Series 03).
-- Series 02 is closed and archived under `archive/`; Series 03 opens on the new
-- foundation. The Series 03 charter (`series-03/charter.md`) grows it.
--
...
--
-- WS1 (`series-03/spec/ws1/4-charter-design-review.md`) — the Groundless Carrier:
...
import ws1
-- WS2 (`series-03/spec/ws2/04-charter-design-review.md`) — `νP_κ` and its
...
import ws2
-- WS3 (`series-03/spec/ws3/04-charter-design-review.md`) — bidirectional
...
import ws6
-- WS7 (`series-03/spec/ws7/04-charter-design-review.md`, v3) — non-collapse, the
...
import ws7
-- WS8 (`series-03/spec/ws8/02-design.md`) — filling the holes A–E: weighted
...
import ws8
-- WS9 (`series-03/spec/ws9/`) — the convergence boundary, a full stratification of where
...
import ws9
-- WS10 (`series-03/spec/ws10/`) — statement–gloss reconciliation from the external
...
import ws10
-- WS11 (`series-03/spec/ws11/02-design.md`) — the identity split: on any coalgebra,
...
import ws11
-- WS12 (`series-03/spec/ws12/02-design.md`) — hereditary non-domination. Every reachable
...
import ws12
-- WS13 (`series-03/spec/ws13/02-design.md`) — pairs and relations as states. The
...
import ws13
-- WS14 (`series-03/spec/ws14/02-design.md`) — the graded carrier defeats the collapse.
...
import ws14
-- WS15 (`series-03/spec/ws15/02-design.md`) — constitutive attention. The dynamics' output

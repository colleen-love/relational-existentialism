/-
Spec 2.4g — the C1 landing over the corrected functor, and P3h's positive half
...
globally. Cf. 2.2 §4's original conjecture route. -/
...
/-! ## Stage 4 — B5 interface pack (2-4-mechanization-c §4; T14 + Reveal + deployable, light) -/
...
/-- Spec 2.1 §3.7 (D15), corrected: an attention is DEPLOYABLE by `x` iff it is the context of some
...
/-! ## Stage 5 — T4 profile scaffolding (2-4-mechanization-c §5; MAY)

/-
`series-04/formal/ws2.lean`

WS2 — **The collapse, and the forced answer.** Series 04, the intellectual spine.
...
Design doc: `series-04/spec/ws02-design.md`. The Collapse Theorem is a faithful
transcription of the Series 03 impossibility `ws10_unlabeled_atomless_collapses`
...
open Cardinal Series04.WS1

namespace Series04.WS2
...
plurality is earned against. Transcribed from Series 03 `ws10`. -/
...
`X ≃ Set X`, i.e. `#X = 2^#X`, contradicting Cantor. Transcribed from Series 03
`ws10`. -/

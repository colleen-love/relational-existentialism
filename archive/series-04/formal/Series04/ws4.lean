/-
`series-04/formal/ws4.lean`

WS4 — **No top, no view from nowhere.** Series 04.
...
object: its successor set is `< κ`, but the carrier is `≥ κ`. This is the Series 03
...
positioned views. Free here rather than manufactured (contrast Series 03's `ws6`,
...
theorem ws4_substantive_standpoints (hinf : ℵ₀ ≤ κ) :
    ∃ a b : Series04.WS3.νLk κ (ULift.{u} Bool), a ≠ b ∧
      Series04.WS3.NonAtomic a ∧ Series04.WS3.NonAtomic b :=
  Series04.WS3.ws3_plurality_core_concrete hinf

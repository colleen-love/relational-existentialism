/-
`series-04/formal/ws6.lean`

WS6 — **The two incompletenesses.** Series 04.
...
* **C** `selfModel` / `attend` / `ws6_selfmodel_is_attention_fixedpoint` — the inward
  ...
  (the Series 03 replicator/pitchfork) is not reproduced in this self-contained pass;
...
quantitative replicator dynamics of Series 03 ws8/ws9 — the pitchfork at `μ⋆ = ½` — are

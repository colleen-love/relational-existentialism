...
**Design doc. Series 04, the intellectual spine. Owns: the Collapse Theorem, the imported-weight leak, and the forced-answer claim (restriction-quality is the essentially-unique atom-free quality).**
...
Two of the three are already proved in Series 03 and are *imported*, not re-derived — WS2's job is to reframe them as the two premises of a single argument and then supply the third (new) step.

| Result | Series 03 source | WS2 role |
|---|---|---|

/-
`series-05/formal/ws7.lean`

WS7 — **The anti-trivialization audit.** Series 05, the honesty workstream. Owns the program
...
The mechanized picture (following the Series 04 R1 discipline): the payoffs are a
...
objective part. Design doc: `series-05/spec/ws07-design.md`.
...
open Cardinal Series05.WS1 Series05.WS2 Series05.WS3 Series05.WS4 Series05.WS6
...
Series 04 R1: this conjoins independently-established facts; it does not derive them from
...
one derivation + one second fact + anchors — the same place and structural reason as Series 04.

/-
`series-05/formal/ws3.lean`

WS3 — **Boundlessness without a wall.** Series 05.
...
carrier `νLk` (Series 04 never needed it), giving the carrier lower bound
...
Design doc: `series-05/spec/ws03-design.md` (candidate B2). Deliverables: `RelatesInf`
...
open Cardinal QPF Functor Series05.WS1 Series05.WS2
...
on the colimit. Series 05 does not solve Series 04's face-bounding problem; it **dissolves**

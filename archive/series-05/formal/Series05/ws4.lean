...
payoff). Design doc: `series-05/spec/ws04-design.md` (A2 + P1/P2 + V1/V3, V2 recorded as
laundering).
...
open Cardinal Series05.WS1 Series05.WS2 Series05.WS3 Series05.WS6
...
record honestly that the naive V2 launders, as Series 04's V2 did. -/
...
(through the facing structure), not a second load path. Its genuine gain over Series 04's V2 is

/-
`series-5/formal/ws5.lean`

WS5 — **The self-bounding of the world, revisited.** Series 5. The "grain, not wall"
thesis, now claimed tower-wide.

Series 5 does **not** refute Series 4's M1/M2/M3 (all true): within a level, faces still
...
open Cardinal Series5.WS1 Series5.WS2 Series5.WS3

namespace Series5.WS5

variable {κ : Cardinal.{u}} {Q : Type u}

/-! ## The Series 4 negatives, transcribed and standing (unrefuted) -/
...
theorem ws5_global_groundless_collapses (hinf : ℵ₀ ≤ κ)
  ...
  Series5.WS2.ws5_global_groundless_collapses hinf h

/-! ## G3 — the off-spine improper-self-face route is rejected -/

/-- **G3 rejected.** The Series 4 spine route does not generalize: the derived self-face is
...
by improper self-faces; Series 5's endogeneity comes from *between* levels (G1/G2), a
different mechanism. -/

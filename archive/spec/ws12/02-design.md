...
**File:** `series-3/formal/ws12.lean`, namespace `Series3.WS12`, `import ws10` (brings `Reaches`, `carrier_card_ge`, and transitively ws1/ws2/ws6 — `bottomState` lives in ws6).

...
*Design register. This workstream converts the external review (`series-03/spec/ws9/03-project-review.md`)
...
> **As built (`series-03/formal/ws10.lean`, sorry-free, axiom-clean).** The keystone
...
3. **README.** Handled separately (already drafted alongside this design): drop
   "one primitive, one axiom" (it describes the Series 02 axiom ledger, not the Series 03
   artifact), scope the existence trade-off as above, cite Series 03 not Spec 2.0.

...
Everything lives in ZFC/Mathlib, `u`-polymorphic, in `namespace Series03.WS2`. WS2 imports the following from `ws1.lean` (Document 3) as *established, axiom-free theorems*:

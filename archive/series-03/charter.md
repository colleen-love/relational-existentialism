...
> workstream (`series-03/spec/ws8`): it discharges, against the *actual* upstream
...
> carried since REV-A on every workstream, is discharged.** `series-03/formal/
...
> external line-by-line audit (`series-03/spec/ws9/03-project-review.md`) named the program's recurring

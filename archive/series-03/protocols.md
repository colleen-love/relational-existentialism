...
- **Context in:** ER.
- **Instructions:** Please merge in main and write the Lean 4 proof for series-03/spec/ws${X}/04-charter-design-review.md in series-03/formal/ws${X}.lean. Import the new lean file in series-03/formal/Series03.lean so that the build compiles the new file, too. Sorry-free and no new axioms is the bar for this design. Ignore the archive directory as it is irrelevant. Once you are finished, please ensure that the build compiles and run #print axioms.

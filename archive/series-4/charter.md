...
This section is the hinge of Series 4. Everything afterward is a response to it.
...
That is precisely the proposal of Series 4.
...
Restriction-quality is a bet, not a theorem, and Series 4 is built to be able to report that the bet failed. Three hazards are load-bearing and named now:
...
Series 4 adds one rule for its own signature risk:

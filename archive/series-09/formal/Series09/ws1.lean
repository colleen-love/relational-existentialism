/-
`series-09/formal/Series09/ws1.lean`

WS1 — **The hold-reflexive carrier and the diagonal spine.** Series 09, the blocking spine.

This file is SELF-CONTAINED: it transcribes (re-namespaced `Series09.WS1`) the plain `P_κ` /
bisimulation machinery, the labelled/face machinery, the collapse, and the Series 08 coincidence
witness (`ws1_symmetric_states_bisimilar`) — nothing is imported from `series-08/`, `series-07/`,
`series-04/`, or `archive/`. On top of that transcribed carrier it adds the Series 09 primitive it
...
a fixed-point contradiction, NOT the Series 08 bisimulation (`ws1_diagonal_not_bisim`).

Design doc: `series-09/spec/ws1-design.md`; shared objects `series-09/spec/README.md` §2.
...
/-! ## The κ-bounded powerset functor `P_κ` (transcribed from Series 08 `ws1`) -/
...
/-! ## The labelled functor and the recoverable/free face test (transcribed from Series 08 `ws1`/`ws4`) -/
...
/-! ## The Series 08 coincidence witness (transcribed as the negative touchstone, §4.1) -/
...
label-bisimilar. This is the thing the Series 09 spine must NOT unfold to (charter §4.1): Series 08's
...
/-! ## The hold-reflexive layer (Series 09, README §2.3) -/
...
Series-08-strength inspection on which the diagonal has nothing to bite. -/

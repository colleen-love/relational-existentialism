...
[`03.8-time-flow.md`](03.8-time-flow.md) §"the seam fixes the target" · the distributed reading is
[`03.13-distributed-self.md`](03.13-distributed-self.md).

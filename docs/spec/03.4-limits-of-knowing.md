...
- **Closing = the self** `[proved/structural]` — the eigenform is the fixed point of the
  ...
  close (sparsity, [03.7](03.7-sparsity.md)), so creation is the rare case. `[follows]`
...
eigenform ([the distributed self](03.6-the-self-quantified.md)) `[reading]` — but it forecloses
...
`no_complete_view` consumes — is mechanized in [`Registration.lean`](../../formal/Scratch/Registration.lean).
...
cartesian diagonal here. [`Knowing.lean`](../../formal/Scratch/Knowing.lean) ties them on one axis.

...
/-- Spec 2.0 T6 / D13(1). One step of constitutive descent: `z` occurs one level
...
descent stops. Triple duty (2.0 §5): A1's "ad infinitum" downward; D13(1)'s "no day
...
/-- Spec 2.0 A4/A6, the formal face: AN OBJECT IS ITS UNFOLDING. Two objects of Ω₀
...
/-- Spec 2.0 §7 / T5: ρ — the finitely-realized objects: images of finite bounded

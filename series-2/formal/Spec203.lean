...
/-- Spec 2.3 D20 — THE F(1) DIAGNOSIS. Over a one-point world there is exactly one
...
/-- Spec 2.3 T17 — THE MIRROR. The constructed universe is a single point: T1
...
/-- Spec 2.3 T18 — THE COINCIDENCE OF EXTREMES. In the collapsed universe the four
...
Ω (2.3 §5). Kept in the file so no later reader mistakes the anchor for the answer. -/

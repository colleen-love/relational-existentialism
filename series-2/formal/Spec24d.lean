...
/-- The doctrine of 2.4 §5, given its formal referent: a relation-point is *hosted* when some
...
/-- Genesis over the corrected universe (2.4, T10 re-anchored): does all multiplicity unfold from
...
/-
================================================================================
2-4-mechanization-b §Frozen predictions ↔ this file (Stages 0–1; see 2.4 §9 Results)
================================================================================

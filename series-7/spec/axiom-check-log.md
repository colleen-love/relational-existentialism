...
Regenerated 2026-07-10 after addressing project-review-1.md (verdict wired to the audit
certificate; genuine drop-1 labelled witness; contentful third kind; real strip witnesses).
...
'Series7.WS3.ws3_history_kind_inhabited' depends on axioms: [propext, Classical.choice, Quot.sound]
'Series7.WS3.ws3_history_kind_collapses' depends on axioms: [propext, Classical.choice, Quot.sound]

/-
`series-6/formal/ws1.lean`

WS1 — **The process and its gate.** Series 6, blocking workstream.
...
from `series-4/`, `series-5/`, or `archive/`.

Design doc: `series-6/spec/ws1-design.md`; shared objects `series-6/spec/README.md` §2.

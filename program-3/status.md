...
The living ledger. Every landing, review, finding, and repair gets a dated entry here, newest last. The charter is the bar; this file is the memory.
...
From Program Review 2-1 (`program-2/spec/program-review-1.md` and its closure ledger): the six disciplines in the charter are law for every series. The standing residues that Program 3 must not repeat: collapsed carriers where every distinction tests as an import; painted tables read back by `decide`; verdict flags as literal booleans; re-seats connected to built objects by prose alone; vacuous audit theorems; interpretive claims exceeding their theorems.

## Permanent opens

Unchanged from Programs 1 and 2, carried untouched: the content of the compass, the direction of convergence, the differentiating act, the classification of the out-of-image imports. Program 3 adds none and closes none. The measure of creation is relativized in this program; its source is not.

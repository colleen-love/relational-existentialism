...
- **One generator, at equilibrium** (handoff XV, [`Theory.OneGenerator`](../formal/Theory/OneGenerator.lean)):
  ...
  Connes–Rovelli frontier below and stays open; whether the framework *forces* the alignment is flagged as the

...
*Current program phase: Phase 1 (Series 2.0–2.3) landed and accepted — verdict **CONSTRUCTED-AND-WALLED**. Phase 2 (Series 2.4–2.8, the physics of the built universe) is in progress: **Series 2.4 (Space) has landed DISTINCT** (including Charter Extension 1, load-bearing self-relativity), accepted on independent Tier-1 review; 2.5–2.8 not yet built. The P1 foundation and Series 2.0–2.4 are built, axiom-clean, and gate-green.*
...
| 2.5 the loop (Phase 2) | do closed causal loops exist, or is time acyclic (the fold as ground)? | TBD | — | chartered (this update) |
| 2.6–2.8 (Phase 2) | the thread, the ledger, the common good | TBD | — | chartered (charter-extension.md); not yet built |

...
theorem ws5_audit_names_not_terms :
    Outcome.frustrated ≠ Outcome.gluable
  ∧ Outcome.gluable ≠ Outcome.shapeDrawn
  ∧ Outcome.shapeDrawn ≠ Outcome.pairwiseOnly
  ∧ Outcome.pairwiseOnly ≠ Outcome.disconnected
  ∧ Outcome.disconnected ≠ Outcome.partial'
  ∧ Outcome.frustrated ≠ Outcome.partial' := by
